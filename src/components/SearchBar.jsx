      ...
      <div className="container mx-auto px-32 py-4">
        <div className="relative flex items-center max-w-2xl mx-auto">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-3 border-2 border-gray-300 rounded-lg focus:border-teal-500 focus:outline-none text-gray-900 placeholder-gray-400 transition-colors"
          />
          <button
            onClick={handleClose}
